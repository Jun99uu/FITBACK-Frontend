...
export default function BeginnerFirst(props: beginnerProps) {
  ...
  const goNextStage = () => {
    if (ac) {
      const newInfo: BeginnerInfo = {
        ...
        state: firstInfo.state !== null ? firstInfo.state : State.Student,
        profile: info.profile,
        attachment: info.attachment,
        imgFile: info.imgFile,
        nickname: info.nickname,
        InterestedCompany: info.InterestedCompany,
        InterestedJob: info.InterestedJob,
      };
      setInfo(newInfo);
      setStage(Stage.BeginnerSecond);
    }
  };
      ...
      <ul>
        ...
        <li className="state-box-wrapper">
          ...
          <span
            ...
            onClick={() => setStateSelector((prev) => !prev)}
          >
            {firstInfo.state ? firstInfo.state : "구직 중"}
          </span>
          {stateSelector ? (
